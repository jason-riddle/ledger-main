"""Ally Bank QFX/OFX format parser."""
...
def parse_qfx_data(
    data: str | bytes, config: Optional[AllyBankConfig] = None
    ...
    for statement in ofx_data.statements:
        for txn in statement.transactions:
            ...
            narration = ofx.build_ofx_narration(tx_type, name, memo, "Ally Bank activity")
